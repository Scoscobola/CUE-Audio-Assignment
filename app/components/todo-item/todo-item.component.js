...
export class TodoItemComponent {
	...
	// New event raises when item is to be removed from archive.
	@Output() itemUnarchived = new EventEmitter();
	...
	// On click, raise event to unarchive item
	unarchive() {
		this.itemUnarchived.next(this.todo.uid)
	}
